    ...
    <div class="form-box shadow-lg">
      <form action="backend/login.php" method="POST"> 
        ...
        if (isset($_SESSION['erro_login'])) {
          echo "<div class='alert alert-danger text-center mt-3'>" . $_SESSION['erro_login'] . "</div>";
          unset($_SESSION['erro_login']);
        }
        ?>

        <p class="text-center mt-3">Não tem uma conta? Faça seu cadastro! 
